...
1. **Fecha límite:** viernes 15/11 a las 13:00 hrs (SCL). Entrega esperada: miércoles 12/11 en horario de la evaluación presencial.
2. **Entrega:** Jupyter Notebooks desarrollados y un **reporte tipo resumen** del trabajo planteado.
...
Se trabajará con un **dataset sintético** con información clínica del **primer trimestre del embarazo**. El objetivo es **caracterizar estadísticamente los datos** y **explorar asociaciones** entre variables clínicas y el **riesgo de desarrollar diabetes gestacional (GDM)**.

### Características del dataset

- N ≈ 1500 registros
- Variables clínicas (ej.: edad, IMC pregestacional, presión arterial)
...
Formular y ejecutar pruebas adecuadas según el tipo de variable y la pregunta planteada. Ejemplos:
...
<sub>Nota: Este documento es la digitalización del contenido de instrucciones entregado en PDF.</sub>
